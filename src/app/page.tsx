...
import { FeatureCard } from "~/app/_components/compounds";
          ...
          <Stack gap="xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <FeatureCard
                ...
                value={eventCount}
                title="Active Events"
                description="Running events happening right now across North Georgia"
              />
              ...
              <FeatureCard
                ...
                icon={
                  ...
                  >
                    ...
                    <path d="M8 38H44" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
                  </svg>
                }
              />
                ...
                icon={
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="none"
                    />
                    <circle cx="21" cy="21" r="10" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.5" />
                    <circle cx="21" cy="21" r="14" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.3" />
